...
git subtree pull --prefix=public/git@github.com:AldridgeCaleb/aldridgecaleb.github.io origin master
...
git subtree push --prefix=public/git@github.com:AldridgeCaleb/aldridgecaleb.github.io origin master